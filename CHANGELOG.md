...
- Single-tier post-quantum finality: a per-operator ML-DSA-65 bitmap-multisig quorum certificate (no BLS aggregate, no FROST distributed key generation), with roughly four-to-eight-second anchor finality.
